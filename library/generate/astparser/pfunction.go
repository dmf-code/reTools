...
// 添加参数
func (this *PFunction) AddParam(param *PParam) {
	this.FunParams = append(this.FunParams, param)
}

// 添加返回值
func (this *PFunction) AddResult(param *PParam) {
	this.FunResult = append(this.FunResult, param)
}
...
// 判断对象是否是 Function，其实就是先找 *ast.Field,然后判断type是否是*ast.FunType
